...
<p align="center"><i>Animierte lebende UMAP-Karte, täglich aktualisiert. Jeder Punkt ist ein Handelstag des Devisenmarkts, 8.877 Tage von 1996 bis 2026, nach Jahr eingefärbt. Die Eingabe für einen Tag hat 83.344 Dimensionen, eine pro Instrument im globalen Marktregister, von denen die 1.992 Devisenpaare die standardisierte Tagesrendite tragen und der Rest null ist. Eine Basiskarte wurde auf den ersten 3.000 Tagen gefittet, und jeder spätere Tag wurde bei seinem Eintreffen in sie eingefaltet. Die Animation zeigt 2007 bis 2026; der <a href="../figures/forex_market_full_1996_2026.mp4">vollständige Lauf ab 1996</a> ist ein achtminütiges Video. Das Verfahren, auf einem synthetischen Datenstrom, der in unter einer Minute durchläuft, steht in <a href="../docs/examples/04_living_map_animation.py">docs/examples/04_living_map_animation.py</a>.</i></p>
