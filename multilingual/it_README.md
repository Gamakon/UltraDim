...
<p align="center"><i>Mappa UMAP viva animata, aggiornata ogni giorno. Ogni punto è un giorno di contrattazione del mercato dei cambi, 8 877 giorni dal 1996 al 2026, colorati per anno. L'ingresso di un giorno ha 83 344 dimensioni, una per strumento nel registro mondiale dei mercati, delle quali le 1 992 coppie di valute portano il rendimento standardizzato di quel giorno e le altre sono zero. Una mappa di base è stata adattata sui primi 3 000 giorni e ogni giorno successivo vi è stato incorporato al suo arrivo. L'animazione mostra dal 2007 al 2026; la <a href="../figures/forex_market_full_1996_2026.mp4">serie completa dal 1996</a> è un video di otto minuti. Il metodo, su un flusso sintetico che gira in meno di un minuto, è in <a href="../docs/examples/04_living_map_animation.py">docs/examples/04_living_map_animation.py</a>.</i></p>
