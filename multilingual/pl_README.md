...
- **Usługi danych syntetycznych** — jednorodne banki hipersfer i augmentacja k-NN klas mniejszościowych dla zbiorów niezrównoważonych
...
<p align="center"><i>Animowana żywa mapa UMAP, aktualizowana codziennie. Każdy punkt to jeden dzień handlowy rynku walutowego, 8 877 dni od 1996 do 2026, pokolorowanych według roku. Wejście dla jednego dnia ma 83 344 wymiary, po jednym na instrument w globalnym rejestrze rynkowym, z których 1 992 pary walutowe niosą standaryzowaną stopę zwrotu z tego dnia, a reszta to zera. Mapa bazowa została dopasowana na pierwszych 3 000 dniach, a każdy kolejny dzień był do niej wtapiany w miarę napływania. Animacja pokazuje lata 2007 do 2026; <a href="../figures/forex_market_full_1996_2026.mp4">pełny przebieg od 1996</a> to ośmiominutowe wideo. Metoda, na syntetycznym strumieniu, który wykonuje się w mniej niż minutę, znajduje się w <a href="../docs/examples/04_living_map_animation.py">docs/examples/04_living_map_animation.py</a>.</i></p>
