...
<p align="center"><i>Mapa UMAP vivo animado, atualizado diariamente. Cada ponto é um dia de negociação do mercado cambial, 8 877 dias de 1996 a 2026, colorido por ano. A entrada de um dia tem 83 344 dimensões, uma por instrumento do registo mundial de mercados, das quais os 1 992 pares cambiais transportam o retorno padronizado desse dia e as restantes são zero. Ajustou-se um mapa base sobre os primeiros 3 000 dias e cada dia posterior foi incorporado nele à medida que chegava. A animação mostra de 2007 a 2026; a <a href="../figures/forex_market_full_1996_2026.mp4">série completa desde 1996</a> é um vídeo de oito minutos. O método, sobre um fluxo sintético que se executa em menos de um minuto, está em <a href="../docs/examples/04_living_map_animation.py">docs/examples/04_living_map_animation.py</a>.</i></p>
